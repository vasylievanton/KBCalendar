...
public class CalendarStyleAttr {
    ...
    public static CalendarStyleAttr getDefAttributes(Context context) {
        ...
        calendarStyleAttr.setSelectedDateCircleColor(ContextCompat.getColor(context, R.color.selected_date_rect_color));
    ...
    public void setDefAttributes(Context context) {
        ...
        setSelectedDateCircleColor(ContextCompat.getColor(context, R.color.selected_date_rect_color));
